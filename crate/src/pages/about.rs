        ...
        html! {
            <Container direction=Direction::Row wrap=Wrap::Wrap class_name="content">
                <Item layouts=vec!(ItemLayout::ItXs(12))>
                    <h2>{"About"}</h2>
                    <p>{"Soweto Con is an annual conference aiming to bring technical IT talks and training on contemporary topics to the Soweto community, exposing upcoming rocket scientists to a broad kaleidoscope (no idea what this word means but Mpho Matlala assured me it is not offensive) of career paths. The conference is also a way to give back to our community through education."}</p>
